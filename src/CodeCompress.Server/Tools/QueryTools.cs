...
internal sealed class QueryTools
{
    ...
    [McpServerTool(Name = "get_module_api", Title = "Get Module API", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "get_symbol", Title = "Get Symbol Source", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "expand_symbol", Title = "Expand Symbol", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "get_symbols", Title = "Get Multiple Symbols", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "search_symbols", Title = "Search Symbols", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "search_text", Title = "Search Text", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "get_hot_path", Title = "Get Hot Path", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
